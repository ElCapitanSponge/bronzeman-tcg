...
final class SidePanelSettingMetadata
{
	...
	static
	{
		...
		entries.add(setting(Section.GENERAL, "foodSettingsMode", "Food Settings",
			"Controls only Eat and Drink inventory actions while Item Usage requires Cards."
		...
		entries.add(setting(Section.THIEVING, "hamPickpocketingMode", "H.A.M. Members",
			"'No Restrictions': H.A.M. Members are unrestricted."
		...
		entries.add(setting(Section.THIEVING, "masterFarmerInsanity",
			"Master Farmer Full Loot", "When enabled, require all 45 Master Farmer seeds. "
				+ "Master Farmers otherwise have no NPC-card or Coins requirement."));
